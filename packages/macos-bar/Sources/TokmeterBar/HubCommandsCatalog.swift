        ...
        HubCommandGroup(
            ...
            commands: [
                .init(id: "daemon-start",
                      ...
                      example: "tokmeter-mcp daemon start"),
                .init(id: "daemon-status",
                      name: "daemon status",
                      description: "Show the daemon port and verified process identity.",
                      example: "tokmeter-mcp daemon status"),
                .init(id: "daemon-stop",
                      name: "daemon stop",
                      description: "Stop the running daemon.",
                      example: "tokmeter-mcp daemon stop"),
            ]
        ),
